...
$^{4}$ \quad Department of Public Health, Hokkaido University, Faculty
...
convergency were confirmed. Posterior probabilites that daily milk
...
study has provided strong evidence that daily milk intake among Japanese
men was associated with delayed and lower hazard of mortality from
stroke especially cerebral infarction.}
...
hazard of dying from stroke. Accelerated failure time models (AFT) under
...
proportional hazard model. AFT model is also helpful in estimating
...
parameter shows how faster/slower individuals in one exposure group
might have an event compared to others among different exposure groups
\citep{Wei1992, ibrahim2014b}. AFT models
...
confounders. Analyses would be conducted stratified by sex or any other
factor that might suggest any modification effect on the association.
...
12 days was 0.65) \citep{Date2005}. From the validation study
\citep{Date2005} of the FFQ, daily consumers of milk was found to have a
...
Since there is significant effect modification by sex found in the total
sample, all of the subsequent analyses were performed in men and women
separately. We calculated sex-specific means (standard deviation, sd)
and proportion of selected baseline characteristics according to the
frequency of milk intake. Age-adjusted stroke mortality rate were
expressed as per 1000 person-year predicted through poisson regression
models.
...
available/considered by our models such as intake of calcium
