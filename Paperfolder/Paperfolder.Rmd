...
\begin{table}[H]
\caption{\label{tab:tab1f}Sex-specific baseline characteristics according to the frequency of milk intake.}
\centering
...
kable(dt, format = "latex", caption = "Summary of posterior Hazard Ratios (HR) of mortality from total stroke, different stroke type according to the frequency of milk intake in men.", booktabs = T, linesep = "") %>%
...
kable_styling(latex_options = c("striped","hold_position"), font_size = 8) %>%
  ...
  footnote(c("Abbreviations: SD, standard deviation; CrI, credible interval; MCSE, Monte Carlo Standard Error;", "Pr(HR < 1) indicates the prabability for posterior HR to be smaller than 1.")) 
