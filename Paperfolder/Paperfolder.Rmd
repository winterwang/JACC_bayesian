...
Detailed results from the Bayesian survival models (crude, age-adjusted and multivariable adjusted) according to the frequency of milk intake separated for men and women are listed in \textbf{Table \ref{tab:tab2}} and \textbf{Table \ref{tab:tab3}}. 
