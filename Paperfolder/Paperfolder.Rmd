...
Detailed results from the Bayesian survival models (crude, age-adjusted and multivariable adjusted) according to the frequency of milk intake separated by sex are listed in \textbf{Table \ref{tab:tab2}} (men) and \textbf{Table \ref{tab:tab3}} (women). Compared to those who never had milk, both men and women had lower hazard of dying from total stroke in crude models. Chances that the posterior HRs were estimated to be lower than 1 for those who had at least 1-2 times/month was higher than 86.5% in men and more than 94.6% in women. However, lower hazard was observed to remain after age or multivariable adjustment only in men. Specifically, the mean (sd; 95% CrI) of posterior multivariable-adjusted HRs for daily male consumers of milk was 0.80 (sd = 0.07; 95% CrI: 0.69, 0.93) with a probability of 99.0% to be smaller than the null value (=1). Daily female milk consumers had posterior HRs that was distributed with mean (sd) of 0.95 (sd = 0.12; 95% CrI: 0.80, 1.17) which had 78.0% of chance that their HRs could be lower than 1. 

Posterior distributions of HRs for mortality from hemorrhagic stroke were found to contain the null value for either men or women among all fitted models. In contrast, men who had milk intake frequency higher than 1-2 times/week were found to be associated with averagely 26%-37% lower hazard of dying from cerebral infarction compared with men who never drank milk (Model 2 in \textbf{Table \ref{tab:tab2}}). We were more than 95.7% sure that these posterior HRs could be lower than 1. No associations were observed between milk intake and hazard of cerebral infarction among women.
...
\resizebox*{\textwidth}{\dimexpr\textheight-\lineskip\relax}{%
...
\hspace{1em}Pr(HR < 1) & - & 86.50\% & 99.90\% & 99.70\% & 93.50\%\\
\addlinespace[0.3em]
...
\rowcolor{gray!6}  \hspace{1em}Pr(HR < 1) & - & 58.70\% & 97.30\% & 96.10\% & 100.00\%\\
\addlinespace[0.3em]
...
\hspace{1em}Pr(HR < 1) & - & 50.60\% & 93.70\% & 89.60\% & 99.00\%\\
\hline
...
\hspace{1em}Pr(HR < 1) & - & 47.20\% & 88.40\% & 86.30\% & 63.10\%\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Model 1}}\\
...
\rowcolor{gray!6}  \hspace{1em}Pr(HR < 1) & - & 31.60\% & 79.70\% & 76.60\% & 87.60\%\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Model 2}}\\
...
\hspace{1em}Pr(HR < 1) & - & 28.80\% & 72.40\% & 64.40\% & 69.30\%\\
\hline
...
\hspace{1em}Pr(HR < 1) & - & 99.10\% & 99.90\% & 99.70\% & 99.50\%\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Model 1}}\\
...
\rowcolor{gray!6}  \hspace{1em}Pr(HR < 1) & - & 96.90\% & 99.80\% & 98.90\% & 100.00\%\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Model 2}}\\
...
\hspace{1em}Pr(HR < 1) & - & 96.10\% & 99.10\% & 97.50\% & 99.80\%\\
\bottomrule
...
kable(dt, format = "latex", caption = "Summary of posterior Hazard Ratios (HR) of mortality from total stroke, different stroke type according to the frequency of milk intake in women (JACC study, 1988-2009).", booktabs = T, linesep = "", align = "lccccc") %>%
    # collapse_rows(columns = 1, valign = "top") %>% 
    row_spec(0, bold = T) %>% 
