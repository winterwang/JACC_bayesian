...
We calculated sex-specific means (standard deviation, sd) and proportion of selected baseline characteristics according to the frequency of milk intake. Age-adjusted stroke mortality rate were expressed as per 1000 person-year predicted through poisson regression models.
...
These findings showed similar negative effect estimates reported previously [@wang_milk_2015], in which the outcomes of interests were focused on cardiovascular diseases and all-cause mortality. Other studies conducted in East Asian populations also suggested comparable results [@umesawa2008dietary;@kondo2013consumption;@ozawa2017dietary;@Talaei_2016]. However the Life Span Study [@sauvaget2003intake] which was conducted about 10 years prior to the JACC Study reported null association between milk intake and fatal stroke among men and women combined who survived from the Hiroshima and Nagasaki atomic bomb. The difference could be explained by the different population targeted as well as the fact that 
