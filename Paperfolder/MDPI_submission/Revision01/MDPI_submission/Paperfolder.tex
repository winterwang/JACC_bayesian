...
participants = 110585, age range: 40-79) to estimate the posterior
...
Markov Chain Monte Carlo simulation process. 100000 posterior samples
...
was associated with delayed and lower hazard of mortality from stroke
...
stroke event. Accelerated failure time models (AFT) under Bayesian
...
stroke was slowed down by a crude acceleration factor (AF) between 0.79
(SD = 0.05; 95\% CrI: 0.74, 0.90) and 0.93 (SD = 0.04; 95\% CrI: 0.85,
1.02) compared with non-consumers. Chan-
...
\noindent  ces that the posterior crude HRs were estimated to be lower
...
and residual confounding. Second, despite reasonable validity of FFQ in
...
occurred were slowed down among men who drank milk regularly.
