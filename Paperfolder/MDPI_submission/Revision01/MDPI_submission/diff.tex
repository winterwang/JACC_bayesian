...
%DIF ADD Paperfolder.tex           Tue Aug 25 23:28:10 2020
...
%DIF -------
from the Japan Collaborative Cohort (JACC) Study (total number of %DIF > 
participants = 110585, age range: 40-79) to estimate the posterior %DIF > 
...
hazard of dying from stroke. \DIFaddbegin \DIFadd{This would require transformation of the
...
(entry of the study) to a fatal stroke event. }\DIFaddend Accelerated failure time
models \DIFaddbegin \DIFadd{(AFT) }\DIFaddend under Bayesian framework are convenient tools that would
help avoid worrying about the \DIFdelbegin \DIFdel{assumption of proportional hazard normally required in a Cox
proportional hazard model and can directly show }\DIFdelend \DIFaddbegin \DIFadd{assumptions of repeatability of a large
...
shows }\DIFaddend how faster/slower individuals in one exposure group might have an
...
consumption (92.1\%) was in the form of whole milk \mbox{%DIFAUXCMD
...
women). \DIFaddbegin \DIFadd{Number of deaths from causes other than stroke were 18868 (10731
...
16.4) in men and women. }\DIFaddend Age-adjusted stroke mortality rates for each
...
}\DIFdelend \DIFaddbegin \DIFadd{These findings showed similar negative effect estimates reported
