...
%DIF ADD Paperfolder.tex           Mon Aug 24 17:53:26 2020
%  In case you need support, please attach all files that are necessary for compiling as well as the log file, and specify the details of your LaTeX setup (which operating system and LaTeX version / tools you are using).

%=================================================================
%DIF 5c5
%DIF < \documentclass[nutrients,article,submitted,moreauthors,pdftex]{Definitions/mdpi}
%DIF -------
\documentclass[nutrients,article,submitted,moreauthors,pdftex]{Definitions/mdpi} %DIF > 
%DIF -------
...
%DIF -------
$^{4}$ \quad Department of Public Health, Hokkaido University, Faculty %DIF > 
of Medicine, Sapporo, Japan; \\ %DIF > 
%DIF -------
}
...
from the Japan Collaborative Cohort (JACC) Study to estimate the
posterior acceleration factors (AF) as well as the hazard ratios (HR)
comparing individuals with different milk intake frequencies against
those who never consumed milk at the study baseline. These estimations
were computed through a series of Bayesian survival models that employed
a Markov Chain Monte Carlo simulation process. 100000 posterior samples
%DIF 138-148c138-148
...
convergency were confirmed. Posterior probabilites that daily milk %DIF > 
...
\DIFadd{Moreover, a }\DIFaddend more intuitive interpretation would be available if we were
...
hazard of dying from stroke. Accelerated failure time models \DIFaddbegin \DIFadd{(AFT) }\DIFaddend under
Bayesian framework are convenient tools that would help avoid worrying
about the assumption of proportional hazard normally required in a Cox
proportional hazard model\DIFdelbegin \DIFdel{and can directly show }\DIFdelend \DIFaddbegin \DIFadd{. AFT model is also helpful in estimating
acceleration factors in addition to hazard ratios which can be
interpreted as the speed for developing an event of interest. This speed
parameter shows }\DIFaddend how faster/slower individuals in one exposure group
might have an event compared to others among different exposure groups
\citep{Wei1992, ibrahim2014b}. \DIFaddbegin \DIFadd{AFT models
}\DIFaddend 
...
12 days was 0.65) \citep{Date2005}. \DIFaddbegin \DIFadd{From the validation study
\mbox{%DIFAUXCMD
\citep{Date2005} }\hspace{0pt}%DIFAUXCMD
of the FFQ, daily consumers of milk was found to have a
median intake of 146 gram per day.
}\DIFaddend 
...
women). Age-adjusted stroke mortality rates for each category of milk
intake frequency was estimated to be 1.8, 2.0, 1.7, 1.6, 1.5 per 1000
person-year for men and 1.3, 1.4, 1.2, 1.1, 1.2 per 1000 person-year for
women.
...
\DIFdelbeginFL %DIFDELCMD < \resizebox*{!}{\dimexpr\textheight-\lineskip\relax}{%
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \resizebox*{!}{\dimexpr\textheight-\lineskip\relax}{%
...
These findings \DIFdelbegin \DIFdel{are in line with our previous report
\mbox{%DIFAUXCMD
\citep{wang_milk_2015} }\hspace{0pt}%DIFAUXCMD
as well as other studies conducted in
East Asian
populations
\mbox{%DIFAUXCMD
\citep{umesawa2008dietary, kondo2013consumption, ozawa2017dietary, sauvaget2003intake, Talaei_2016}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{showed similar negative effect estimates reported
previously \mbox{%DIFAUXCMD
\citep{wang_milk_2015} }\hspace{0pt}%DIFAUXCMD
using data from the same cohort, in
which the outcomes of interests were focused on cardiovascular diseases
and all-cause mortality}\DIFaddend . Moreover, we have further updated \DIFaddbegin \DIFadd{the results
}\DIFaddend with more comprehensive and straightforward evidence about whether and
...
of 18 prospective cohort studies had \DIFdelbegin \DIFdel{also }\DIFdelend shown a similar negative
...
American populations \citep{dehghan2018association}. \DIFaddbegin \DIFadd{However, the Life
Span Study \mbox{%DIFAUXCMD
\citep{sauvaget2003intake}}\hspace{0pt}%DIFAUXCMD
, which was conducted about 10
...
possible to alter over time and these would resulted in misclassfication
...
observed associations may have attenuated. Strengths of our analyses
included that we have transformed the research questions to more
transparent ones that is easier for interpretation. Direct probabilities
that daily milk intake is associated with lower hazard or delayed stroke
mortality event were provided here after thorough computer simulations.
\DIFaddbegin 
